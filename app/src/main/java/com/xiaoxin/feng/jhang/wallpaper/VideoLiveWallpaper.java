...
//        Log.e(TAG, "setToWallPaper: sVideoPath"+sVideoPath);
        final Intent intent = new Intent(WallpaperManager.ACTION_CHANGE_LIVE_WALLPAPER);
        intent.putExtra(WallpaperManager.EXTRA_LIVE_WALLPAPER_COMPONENT,
                new ComponentName(context, VideoLiveWallpaper.class));
        context.startActivity(intent);
        Log.e("sss", "setToWallPaper: sVideoPath"+sVideoPath);
    ...
    class VideoEngine extends Engine {
        ...
        private VideoVoiceControlReceiver mVideoParamsControlReceiver;
        ...
        public void onCreate(SurfaceHolder surfaceHolder) {
            ...
            mVideoParamsControlReceiver = new VideoVoiceControlReceiver();
        ...
        public void onSurfaceCreated(SurfaceHolder holder) {
            ...
            Log.e(TAG, "onSurfaceCreated111: "+sVideoPath );
            try {
//                AssetManager assetMg = getApplicationContext().getAssets();
//                AssetFileDescriptor fileDescriptor = assetMg.openFd("test2.mp4");
