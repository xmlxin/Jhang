...
public class SelKsSecondAdapter extends BaseQuickAdapter<BwBean.DataBean, BaseViewHolder> {

    private SparseBooleanArray mBooleanArray;
    private int mLastCheckedPosition = -1;

    private Context mContext;
    public SelKsSecondAdapter(int layoutResId, @Nullable List<BwBean.DataBean> data, Context context) {
